...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<%@page import="java.util.Map,com.spring.bean.ReservationBean,java.util.ArrayList,com.spring.bean.PassengerBean" %>
...
<table align="center" style="margin: 0px; width: 100%;">
<thead>
<tr>
	<th>Name</th>
	<th>Age</th>
...
%>
		...
		<input type="button" id="print" onclick="javascript:window.print();" value="PRINT TICKET"/>
		<form action="pdf" method="post"><input type="submit" value="Save Ticket As PDF"/></form>
</div>
</center>
</body>
