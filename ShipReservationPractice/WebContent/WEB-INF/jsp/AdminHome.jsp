	...
	<body>
			...
			<!-- Header -->
				<header id="header" class="alt">
					<h1><a href="/ShipReservationPractice/AdminHome"><span>Welcome, </span><%=userid %></a></h1>
					<nav id="nav">
						<ul>
							<li class="current"><a href="/ShipReservationPractice/AdminHome">HOME</a></li>
							<li class="current"><a href="/ShipReservationPractice/changePassword" target="allpages">CHANGE PASSWORD</a></li>
							<li class="submenu">
								<a href="#">ADD</a>
								<ul>
									<li><a href="/ShipReservationPractice/addShip" class="button" target="allpages">SHIP</a></li>
									<li><a href="/ShipReservationPractice/addRoute" class="button" target="allpages">ROUTE</a></li>
									<li><a href="/ShipReservationPractice/addSchedule" class="button" target="allpages">SCHEDULE</a></li>
							...
							<li class="submenu">
								...
								<ul>
									<li><a href="/ShipReservationPractice/viewDetails" class="button" target="allpages">SHIP</a></li>
									<li><a href="/ShipReservationPractice/viewRouteDetails" class="button" target="allpages">ROUTE</a></li>
									<li><a href="/ShipReservationPractice/viewShipScheduleDetails" class="button" target="allpages">SCHEDULE</a></li>
							...
							<li class="current"><a href="/ShipReservationPractice/viewPassenger" target="allpages">View Passengers</a></li>
