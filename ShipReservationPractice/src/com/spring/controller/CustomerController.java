...
import com.spring.dao.ReservationDAOImpl;
...
public class CustomerController {
	...
	public ModelAndView pay(ModelMap model,HttpSession session,HttpServletRequest request,@ModelAttribute("cb")CreditCardBean creditCardBean) throws ParseException {
