				...
				<!-- <div class="logo">
				 ...
				 <div class="top-menu">
					...
					<ul>
						 ...
						 <li><a class="active hvr-shutter-out-horizontal" href="viewAllApps.jsp">View All Apps</a></li>
...
<div class="promo">
  ...
  <ul class="features">
    ...
    <%}else{%>
    <li>Fraud App <a href="accept.jsp?id=<%=rs.getString("id")%>" style="color: blue;">Accept</a></li>  
    <%
    } %>
  </ul>
  <br>
