...
<div class="banner">
	 <div class="container">
				...
				<!-- <div class="logo">
				 ...
				 <div class="top-menu">
					...
					<ul>
						 ...
						 <li><a class="hvr-shutter-out-horizontal" href="viewAvailableApps.jsp">View Available App</a></li>
						 <li><a class="active hvr-shutter-out-horizontal" href="viewMyApps.jsp">My Apps</a></li>
		 ...
		 <div class="promos">
				    ...
				    byte[] img=null;
                    try{
                    	String sql="SELECT * FROM downloads WHERE userId='"+session.getAttribute("userId")+"'";
                    	Connection conn=dbConnection.getConn();
                    	PreparedStatement pstmt=conn.prepareStatement(sql);
                    	ResultSet rs=pstmt.executeQuery();
                    	while(rs.next()){
                    		String sql1="SELECT * FROM apps WHERE id='"+rs.getString("appId")+"'";
...
<div class="promo">
  <div class="deal">
    <span><%=rs1.getString("appName") %></span>
    <span><%=rs1.getString("description") %></span>
  </div>
  <span class="price"><img  src="data:image/jpeg;base64, <%=getByteCode %>" onerror="this.src='app.jpg'" width="160" height="160" ></span>
  <ul class="features">
    <li><%=rs1.getString("platform") %></li>
    <li><%=rs1.getString("ownerName") %></li>
    <li>
    ...
    <input type="hidden" value="<%=rs1.getString("id")%>" name="id">
    <textarea rows="3" cols="13" name="review"></textarea>
